...
float getPUPPIweight(float puppipt, float puppieta ){
  ...
  double barrleMean[8]={1.1197,1.10751,1.10007,1.10314,1.10409,1.10831,1.11815,1.1265};
  double endcapMean[8]={1.27667,1.22533,1.2026,1.18606,1.17546,1.16465,1.16794,1.16553};
 double barrlex[8]={336.323,423.927,563.371,654.101,748.584,838.198,1154.79,1382.88};
 double endcapx[8]={307.466,387.92,490.26,551.006,618.135,666.284,850.571,944.177};
